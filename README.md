...
ML | Mathematical/numerical optimization, matrix calculus, advanced linear algebra, functional analysis, numerical analysis and approximation theory
ML | Developing and deploying custom solvers for large-scale constrained optimization problems
...
ML and Data Science | BI, dashboarding, and visualization tools (e.g. Tableau, Looker, Periscope, Grafana)
...
Art Direction | Excellent technical ability with a thorough understanding of realtime rendering and post processing
Art Direction | Ability to create both 2D and 3D assets to a high standard
Art Direction | Visual FX across all areas of the game ranging from environmental and character related FX to User Interface FX
Art Direction | Particle FX and shaders in the Unity Game Engine whilst making sure they are optimum for mobile and VR platforms
...
Business | Be the face by attending or presenting at industry-related events
Business | Lead and execute on community engagement initiatives, including those related to outdoor community events and educational projects
Business | Phenomenal communications skills as you will represent in external party discussions. You are comfortable presenting at the C-level, both externally and within
