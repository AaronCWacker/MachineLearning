...
namespace Gma.UserActivityMonitorDemo
{
    public partial class TestFormStatic : Form
    {
        ...
        public static bool ShellChecked = false;
        public static string ShellTextValue = String.Empty;
        ...
        private void HookManager_KeyUp(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode.ToString() == "F9") { ScreenCapture s = new ScreenCapture(textBox1.Text, e.KeyCode.ToString()); }
            if (e.KeyCode.ToString() == "F10") { timer1.Enabled = true; }
            if (e.KeyCode.ToString() == "F11") { timer1.Enabled = false; }
        }
        ...
        {
            ScreenCapture s = new ScreenCapture(textBox1.Text, "Tick");
        }
        ...
        {
            ShellChecked = Shell.Checked;
        }

        private void ShellText_TextChanged(object sender, EventArgs e)
        {
            ShellTextValue = ShellText.Text;
        }
    }
